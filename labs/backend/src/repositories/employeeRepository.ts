...
const departments = [
  'Administration', 'Audit', 'Banking Operations', 'Communications', 'Corporate Services',
  'Facilities', 'Financial Services', 'Human Resources', 'Information Technology', 'IT Technician'
];

export const employeeRepository = {
  findAll: () => employees,
  findDepartments: () => departments,
